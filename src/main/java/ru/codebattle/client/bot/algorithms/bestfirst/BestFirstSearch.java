    ...
    public void pathToGold(BoardPoint myCurPos, BoardPoint p2) {
        ...
        while (distance(curPos, p2) != 0) {
            if (curPos.getY() != 0 && !curPos.getVisited().contains(0)) { // Check down direction
                ...
                path_weight += BoardElementWeight
                        .valueOf(gameBoard.getElementAt(point_down).name()).getWeight();
                ...
                path_weight += BoardElementWeight
                        .valueOf(gameBoard.getElementAt(point_up).name()).getWeight();
                ...
                path_weight += BoardElementWeight
                        .valueOf(gameBoard.getElementAt(point_left).name()).getWeight();
                ...
                path_weight += BoardElementWeight
                        .valueOf(gameBoard.getElementAt(point_right).name()).getWeight();
